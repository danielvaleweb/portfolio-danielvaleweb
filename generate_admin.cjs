...
export default function Admin() {
  ...
  return (
    <div className={\`flex h-screen bg-gray-100 dark:bg-[#050505] text-gray-900 dark:text-[#E5E5E5] font-sans overflow-hidden w-full relative z-[100] fixed inset-0\`}>
      ...
      {/* Sidebar */}
      <aside className={\`\${isSidebarCollapsed ? 'w-[70px]' : 'w-[260px]'} flex-shrink-0 border-r border-gray-200 dark:border-[#1a1a1a] flex flex-col h-full overflow-hidden bg-white dark:bg-[#0a0a0a] z-10 pb-6 hidden md:flex transition-all duration-300\`}>
        <div className={\`h-[64px] flex-shrink-0 flex items-center \${isSidebarCollapsed ? 'justify-center' : 'justify-between px-6'} mb-4\`}>
          ...
          <div className="flex items-center gap-2 relative">
            ...
            {showMenuConfig && !isSidebarCollapsed && (
              <div className="absolute top-8 left-0 w-48 bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#333] rounded-xl shadow-lg p-3 z-50">
        ...
        <div className="px-3 flex-1 overflow-y-auto custom-scrollbar flex flex-col justify-start">
          <div className="mb-6">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-0.5">
              ...
              <NavItem icon={Globe} label={lang === 'pt' ? t.language : t.ptLanguage} onClick={toggleLanguage} collapsed={isSidebarCollapsed} />
              <NavItem icon={theme === 'dark' ? Sun : Moon} label={theme === 'dark' ? 'Light Mode' : t.nightMode} onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')} collapsed={isSidebarCollapsed} />
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col h-full overflow-hidden bg-gray-100 dark:bg-[#050505]">
        
        {/* Top Header Collapsible wrapper */}
        {isNavbarCollapsed ? (
          <div className="flex justify-center -mb-4 z-50 relative top-0">
          ...
          <header className="h-[64px] flex-shrink-0 border-b border-gray-200 dark:border-[#1a1a1a] flex items-center justify-between px-4 md:px-8 bg-white dark:bg-[#0a0a0a] transition-all">
            ...
            <div className="flex items-center gap-2 md:gap-4 relative">
              ...
              <div className="relative">
                ...
                {showNotifications && (
                  <div className="absolute right-0 top-10 w-64 bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#333] rounded-xl shadow-lg p-4 z-50">
              ...
              <div className="relative">
                ...
                {showProfileMenu && (
                  <div className="absolute right-0 top-10 w-32 bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#333] rounded-xl shadow-lg py-1 z-50">
                    <button 
                      onClick={() => {
        ...
        <main className="flex-1 overflow-hidden flex flex-col">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-10 pt-10 flex-1 w-full flex flex-col overflow-hidden">
            ...
            {isCreating || editingProject ? (
              <div className="bg-white dark:bg-[#111] rounded-3xl border border-gray-200 dark:border-[#222] p-6 sm:p-8 flex-1 overflow-y-auto custom-scrollbar">
                <ProjectForm 
              ...
              <div className="flex-1 bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#1f1f1f] rounded-3xl p-8 flex flex-col justify-center items-center shadow-sm h-full">
              ...
              <div className="flex-1 flex flex-col h-full overflow-hidden">
                <div className={\`flex-1 \${viewMode === 'grid' ? "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5" : "flex flex-col gap-3"} overflow-hidden pb-4\`}>
                  ...
                  {paginatedProjects.length === 0 && (
                    <div className="col-span-full flex items-center justify-center h-full text-gray-500 dark:text-[#777]">
                       {t.noProjects}
                    </div>
                  )}
                </div>
            ...
            {/* Footer */}
            {(!isCreating && !editingProject) && (
              <footer className="py-4 flex-shrink-0 flex flex-col xl:flex-row items-center justify-between text-gray-500 dark:text-[#666] text-[11px] font-medium gap-6 border-t border-gray-200 dark:border-[#1a1a1a]">
                <p>© 2076 Constructor Global Inc.</p>
                ...
                <div className="flex flex-wrap items-center justify-center gap-6">
                  ...
                  <div onClick={toggleLanguage} className="flex items-center gap-2 bg-white dark:bg-[#111] border border-gray-200 dark:border-[#222] px-4 py-2 rounded-full cursor-pointer hover:bg-gray-50 dark:hover:bg-[#1a1a1a] hover:border-gray-300 dark:hover:border-[#333] transition-colors text-gray-600 dark:text-[#999]">
